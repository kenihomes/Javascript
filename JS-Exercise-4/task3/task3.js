...
function addNameRow(fName, lName) {
  let firstName;
  let lastName;

  if (fName == '' || fName == null) {
    firstName = document.getElementById('mainName').value;
  } else {
    firstName = fName;
  }

  if (lName == '' || lName == null) {
    lastName = document.getElementById('mainLast').value;
  } else {
    lastName = lName;
  }
...
function renderData() {
  let data_array = [
    { FirstName: "kishan", LastName: "desai" },
    { FirstName: "ramesh", LastName: "desai" },
    { FirstName: "naruto", LastName: "uzumaki" },
    { FirstName: "monkey", LastName: "D.luffy" },
    { FirstName: "Roronoa", LastName: "Zoro" },
    { FirstName: "hatake", LastName: "kakashi" },
    { FirstName: "jeet", LastName: "chatrala" },
    { FirstName: "herin", LastName: "zaveri" },
    { FirstName: "gopi", LastName: "jashani" },
    { FirstName: "minato", LastName: "namikaze" },
  ];

  data_array.forEach((obj) => {
    addNameRow(obj["FirstName"], obj["LastName"]);
  });
}
